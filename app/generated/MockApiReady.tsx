...
export default function MockApiReady() {
  return (
    <section
          ...
          <div className="grid grid-cols-1 items-stretch gap-12 md:grid-cols-2">
            <div className="rounded-[2.5rem] bg-emerald-100 p-10 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05),0_0_20px_0_rgba(0,0,0,0.02)]">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between rounded-2xl border border-emerald-100/50 bg-white/40 p-4">
                  <span className={`${jetbrainsMono.className} font-semibold text-gray-800`}>id</span>
                  <span className={`${jetbrainsMono.className} rounded bg-emerald-100/50 px-2 py-1 text-xs text-emerald-600`}>
                    UUID
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-2xl border border-emerald-100/50 bg-white/40 p-4">
                  <span className={`${jetbrainsMono.className} font-semibold text-gray-800`}>title</span>
                  <span className={`${jetbrainsMono.className} rounded bg-emerald-100/50 px-2 py-1 text-xs text-emerald-600`}>
                    String
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-2xl border border-emerald-100/50 bg-white/40 p-4">
                  <span className={`${jetbrainsMono.className} font-semibold text-gray-800`}>price</span>
                  <span className={`${jetbrainsMono.className} rounded bg-emerald-100/50 px-2 py-1 text-xs text-emerald-600`}>
                    Float
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-2xl border border-emerald-100/50 bg-white/40 p-4">
                  <span className={`${jetbrainsMono.className} font-semibold text-gray-800`}>in_stock</span>
                  <span className={`${jetbrainsMono.className} rounded bg-emerald-100/50 px-2 py-1 text-xs text-emerald-600`}>
                    Boolean
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-2xl border border-emerald-100/50 bg-white/40 p-4">
                  <span className={`${jetbrainsMono.className} font-semibold text-gray-800`}>category</span>
                  <span className={`${jetbrainsMono.className} rounded bg-emerald-100/50 px-2 py-1 text-xs text-emerald-600`}>
                    String
                  </span>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="group flex items-center justify-between gap-4 rounded-2xl border border-gray-100 bg-gray-50 p-6 transition-colors hover:border-gray-200">
                    <code className={`${jetbrainsMono.className} truncate text-lg text-gray-600`}>
                      https://mock.apideck.com/v1/gk8v2-91j2
                    </code>
                    <button
                      type="button"
